    ...
    public void printRecommendationsFor(String webRaterID) {
		...
		"</tr>");        		  
            for (int i = 0; i < recommendations.size(); ++i) {
                ...
                System.out.print("<tr>"+
		"<td>"+
		      MovieDatabase.getTitle(recommendations.get(i).getItem())+"</td>");
		System.out.print(""+
		"<td>"+
		      MovieDatabase.getGenres(recommendations.get(i).getItem())+"</td>");
		System.out.print(""+
		"<td>"+
		      MovieDatabase.getYear(recommendations.get(i).getItem())+"</td>");
		System.out.print(""+
		"<td>"+
		      MovieDatabase.getMinutes(recommendations.get(i).getItem())+"</td>");
		System.out.print("</tr>");
